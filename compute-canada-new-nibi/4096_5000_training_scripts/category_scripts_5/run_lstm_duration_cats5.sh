#!/bin/bash
#SBATCH --job-name=lstm_duration_cats5_4096_5000
...
LOG_DIR=$PROJECT/logs/lstm_duration_cats5_seq4096_5000_${SLURM_JOB_ID}
...
echo "Mode         : LSTM | Duration-only | paper bins=5 | seq=4096_5000"
...
python -u microservice/train_sockshop.py \
  ...
  --wandb_run_name "lstm_duration_cats5_seq4096_5000_${SLURM_JOB_ID}" \
  --log_dir "$LOG_DIR" \
  --gpu 0
