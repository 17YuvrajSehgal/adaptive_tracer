#!/bin/bash
#SBATCH --job-name=lstm_multitask_cats7_512_5000
...
LOG_DIR=$PROJECT/logs/lstm_multitask_cats7_seq512_5000_${SLURM_JOB_ID}
...
echo "Mode         : LSTM | Multitask | paper bins=7 | seq=512_5000"
...
python -u microservice/train_sockshop.py \
  ...
  --wandb_run_name "lstm_multitask_cats7_seq512_5000_${SLURM_JOB_ID}" \
  --log_dir "$LOG_DIR" \
  --gpu 0
