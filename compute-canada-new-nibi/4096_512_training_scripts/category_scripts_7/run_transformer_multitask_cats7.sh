#!/bin/bash
#SBATCH --job-name=trf_multitask_cats7_4096_512
...
LOG_DIR=$PROJECT/logs/transformer_multitask_cats7_seq4096_512${SLURM_JOB_ID}
...
echo "Mode         : Transformer | Multitask | paper bins=7 | seq=4096_512"
...
python -u microservice/train_sockshop.py \
  ...
  --wandb_run_name "transformer_multitask_cats7_seq4096_512_${SLURM_JOB_ID}" \
  --log_dir "$LOG_DIR" \
  --gpu 0
