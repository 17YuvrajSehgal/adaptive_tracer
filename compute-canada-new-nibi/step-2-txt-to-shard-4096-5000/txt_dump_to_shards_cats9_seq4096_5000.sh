#!/bin/bash
#SBATCH --job-name=txt_dump_to_shards_9cat_4096
...
OUTPUT_DIR=$SCRATCH/micro-service-trace-data/preprocessed_lmat_kernel_cats9_seq4096
...
echo "============================================================"
echo "Job            : txt_dump_to_shards_cats9_seq4096"
