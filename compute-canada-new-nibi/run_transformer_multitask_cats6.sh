#!/bin/bash
#SBATCH --job-name=trf_multitask_cats6
...
LOG_DIR=$PROJECT/logs/transformer_multitask_cats6_${SLURM_JOB_ID}
...
echo "Mode         : Transformer | Multitask | cats=6"
...
python -u microservice/train_sockshop.py \
  ...
  --wandb_run_name "transformer_multitask_cats6_${SLURM_JOB_ID}" \
  --log_dir "$LOG_DIR" \
  --gpu 0
