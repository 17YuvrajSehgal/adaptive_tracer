...
OUTPUT_DIR=$SCRATCH/micro-service-trace-data/preprocessed_cats6
...
srun python -u microservice/preprocess_sockshop.py \
    ...
    --max_seq_len 512 --n_categories 6 --shard_size 5000 --vocab_only

echo "[$(date +%T)] vocab cats6 done → $OUTPUT_DIR"
