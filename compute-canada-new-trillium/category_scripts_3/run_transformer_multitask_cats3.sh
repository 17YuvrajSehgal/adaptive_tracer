#!/bin/bash
#SBATCH --job-name=trf_multitask_cats3
...
DATA=$WORKROOT/micro-service-trace-data/preprocessed_lmat_kernel_cats3_seq4096
LOG_DIR=$PROJECT/logs/transformer_multitask_cats3_seq4096_${SLURM_JOB_ID}
...
echo "Mode         : Transformer | Multitask | paper bins=3 | seq=4096"
...
python -u microservice/train_sockshop.py \
  ...
  --wandb_run_name "transformer_multitask_cats3_seq4096_${SLURM_JOB_ID}" \
  --log_dir "$LOG_DIR" \
  --gpu 0
