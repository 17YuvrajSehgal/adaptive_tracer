#!/bin/bash
#SBATCH --job-name=trf_event_cats5_512
...
LOG_DIR=$PROJECT/logs/transformer_event_cats5_seq512_${SLURM_JOB_ID}
...
echo "Mode         : Transformer | Event-only | paper bins=5 | seq=512"
