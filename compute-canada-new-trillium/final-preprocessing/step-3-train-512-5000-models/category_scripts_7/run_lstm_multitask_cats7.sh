#!/bin/bash
#SBATCH --job-name=lstm_multitask_cats7_512
...
DATA=$WORKROOT/micro-service-trace-data/preprocessed_lmat_kernel_cats7_seq512
LOG_DIR=$PROJECT/logs/lstm_multitask_cats7_seq512_${SLURM_JOB_ID}
...
echo "Mode         : LSTM | Multitask | paper bins=7 | seq=512"
...
python -u microservice/train_sockshop.py \
  ...
  --wandb_run_name "lstm_multitask_cats7_seq512_${SLURM_JOB_ID}" \
  --log_dir "$LOG_DIR" \
  --gpu 0
