#!/bin/bash
#SBATCH --job-name=trf_event_cats7_512
...
LOG_DIR=$PROJECT/logs/transformer_event_cats7_seq512_${SLURM_JOB_ID}
...
echo "Mode         : Transformer | Event-only | paper bins=7 | seq=512"
