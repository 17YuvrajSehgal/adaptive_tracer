#!/bin/bash
#SBATCH --job-name=trf_multitask_cats7_512
...
LOG_DIR=$PROJECT/logs/transformer_multitask_cats7_seq512_${SLURM_JOB_ID}
...
echo "Mode         : Transformer | Multitask | paper bins=7 | seq=512"
