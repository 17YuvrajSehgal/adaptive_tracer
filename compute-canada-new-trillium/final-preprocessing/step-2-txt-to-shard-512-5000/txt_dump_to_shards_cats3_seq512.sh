#!/bin/bash
#SBATCH --job-name=txt_dump_to_shards_3cat_512
...
OUTPUT_DIR=$SCRATCH/micro-service-trace-data/preprocessed_lmat_kernel_cats3_seq512
...
echo "============================================================"
echo "Job            : txt_dump_to_shards_cats3_seq512"
