#!/bin/bash
# Trillium GPU debug test (1 GPU, <= 2 hours)
#SBATCH --job-name=sockshop_debug
...
LOG_DIR=$SCRATCH/adaptive_tracer/logs/sockshop_debug_${SLURM_JOB_ID}
...
echo "[5/6] Run a SMALL smoke training (fast) + skip heavy eval cadence"
cd "$PROJECT"
